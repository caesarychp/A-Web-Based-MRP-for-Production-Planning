...
(1001, 1001, 60, '2024-05-02 16:32:41');
...
INSERT INTO `material` (`id_material`, `material_name`, `stock`, `price`) VALUES
(1001, 'beras', 100, '5000');
...
(1001, 'Plan-SATU', 1001, 70, '2024-05-31', 1);
...
(1001, 1001, 3, 1001, '2024-05-03', 1),
(1002, 1001, 2, 1002, '2024-05-03', 0),
(1003, 1001, 3, 1003, '2024-05-02', 1);
...
(1001, 'Bag', 'maidsabdsbhjefejjscsj', 'kmacjsacuafniuajsciua');
...
(1001, 'PJ-ONE', 1, 1001, 10, 120, '2024-05-02', 0);
...
CREATE TABLE `staff` (
  ...
  `email` varchar(25) NOT NULL,
  `st_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=Ready\r\n1=Schedule '
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1001, 'tata', 1234567, 'tata@BACOT.COM', 1),
(1002, 'battler', 1234567, 'okay@oke.com', 1),
(1003, 'battler 2', 1234567, 'okay@oke.com', 1),
(1004, 'battler 2', 1234567, 'okay@oke.com', 0);
...
--
ALTER TABLE `machine`
  MODIFY `id_machine` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1011;

--
-- AUTO_INCREMENT for table `material`
--
ALTER TABLE `material`
  MODIFY `id_material` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1008;

--
-- AUTO_INCREMENT for table `planning`
--
ALTER TABLE `planning`
  MODIFY `id_plan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1003;

--
-- AUTO_INCREMENT for table `plan_shift`
--
ALTER TABLE `plan_shift`
  MODIFY `id_planshift` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1004;
...
--
ALTER TABLE `project`
  MODIFY `id_project` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1003;
...
--
ALTER TABLE `staff`
  MODIFY `id_staff` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1015;
